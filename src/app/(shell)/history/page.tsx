...
export default function HistoryPage() {
  ...
  const [documentNoteId, setDocumentNoteId] = useState("");
  ...
  useEffect(() => { void api<WorkspaceNote[]>("/api/v1/notes").then((noteList) => { setNotes(noteList); setDocumentNoteId(noteList[0]?.id ?? ""); }).catch((reason) => setError(reason instanceof Error ? reason.message : "Failed to load Timeline.")); }, []);
